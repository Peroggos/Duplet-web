...
export const Button: React.FC<ButtonProps> = ({
  ...
  const variants = {
    primary: 'bg-primary-600 text-black hover:bg-primary-700 focus:ring-primary-500 disabled:bg-primary-300',
    secondary: 'bg-gray-600 text-black hover:bg-gray-700 focus:ring-gray-500 disabled:bg-gray-300',
